...
| **CrystalNet** | 2024 | Diffraction-like representation → electron density / structure | Coordinate-based VAE for electron density | ≳93% SSIM for selected cubic/trigonal cases | [npj Computational Materials](https://www.nature.com/articles/s41524-024-01401-8) | [gabeguo/deep-crystallography-public](https://github.com/gabeguo/deep-crystallography-public) |
...
| **DiffractGPT** | 2025 | PXRD-conditioned text generation → CIF-like crystal descriptions | Large-token GPT / AtomGPT-style generative model | 0.28 Å lattice MAE in author-reported setting | [J. Phys. Chem. Lett.](https://pubs.acs.org/doi/full/10.1021/acs.jpclett.4c03137) | [atomgptlab/atomgpt](https://github.com/atomgptlab/atomgpt) |
| **Uni3DAR** | 2025 | PXRD / structure tokens → 3D crystal generation | Hierarchical tokenization + 3D autoregressive generation | 0.02 RMSE in author-reported setting | [arXiv](https://arxiv.org/abs/2503.16278) | [dptech-corp/Uni-3DAR](https://github.com/dptech-corp/Uni-3DAR) |
...
| **Automated Rietveld Refinement via ML** | 2026 | Fast Rietveld-like refinement / parameter prediction | Convolutional neural network trained on simulated PXRD profiles | Demonstrated refined structures for CeO₂, Tb₂BaCoO₅, and PbSO₄ with reliability factors comparable to conventional Rietveld refinement | [Journal of Applied Crystallography / PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC11988465/) | Article-provided workflow; standalone code not found during 2026-05-09 pass |
...
| **Perov-5** | ≈1–3k | Sim | CIF + PXRD | Small-cell ABO₃ / perovskite benchmark | [Figshare](https://figshare.com/articles/dataset/Perov5/22705189) |
| **Carbon-24** | ≈6k | Sim | CIF + PXRD | Carbon allotrope benchmark | [Hugging Face](https://huggingface.co/datasets/albertvillanova/carbon_24) |
...
| **JARVIS-DFT XRD** | 20k–60k scale | Sim | DB / API | Broad inorganic computed structures and simulated XRD; used by GPT-style pretraining | [JARVIS](https://jarvis.nist.gov/) |
| **CHILI-3K / CHILI-100K** | 100k+ | Sim | CIF + PXRD | Large simulated crystal/XRD benchmark used by deCIFer-style workflows | [CHILI GitHub](https://github.com/UlrikFriisJensen/CHILI) |
| **SimXRD-4M** | 4.06M | Sim | Spectra shards | Large crystal-symmetry prediction benchmark | [OpenReview](https://openreview.net/forum?id=mkuB677eMM) |
...
| **PowBase** | 169 | Exp | `.dat` / `.cif` | Historical experimental PXRD collection; limited labels | [PowBase](http://www.cristal.org/powbase/index.html) |
| **Crystallography Open Database experimental PXRD subset** | ≈1,052 | Exp | CIF + PXRD | Labeled experimental PXRD with full structures where available | [COD](https://www.crystallography.net/cod/) |
| **RRUFF** | 3k+ | Exp | DB / spectra | Reference mineral Raman/XRD data; commonly used for experimental transfer | [RRUFF](https://rruff.info/) |
| **XRed** | ≈2k | Exp | `.xy` | High-quality experimental mineral patterns | [WPEM/XRED](https://github.com/WPEM/XRED) |
| **opXRD** | 92,552 | Exp | `.xyz` and metadata | Open experimental PXRD database sourced from multiple research institutes; useful for experimental-domain adaptation and retrieval | [Zenodo](https://zenodo.org/records/15298026) |
...
| **GSAS-II** | Rietveld refinement and diffraction analysis | Standard crystallographic refinement package; also used for simulation in ML data generation | [GSAS-II](https://subversion.xray.aps.anl.gov/trac/pyGSAS) |
